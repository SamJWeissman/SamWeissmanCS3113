...
DrawingManager::DrawingManager()
{
	...
	spriteSheetTexture = LoadTexture("alienBeige.png");
	explosionTexture = LoadTexture("explosion08.png");
}
DrawingManager::~DrawingManager()
{
...
void DrawingManager::DrawStatBoard(int health, int energy, int score)
{
	DrawSomeText("Health: " + std::to_string(health), -2.63f, 1.96f, 0.15f, 0.0f, 1.0f, 1.0f, 1.0f, 1.0f);
	DrawSomeText("Energy: " + std::to_string(energy), -.8f, 1.96f, 0.15f, 0.0f, 1.0f, 1.0f, 1.0f, 1.0f);
	DrawSomeText("Score: " + std::to_string(score), 1.3f, 1.96f, 0.15f, 0.0f, 1.0f, 1.0f, 1.0f, 1.0f);
}
